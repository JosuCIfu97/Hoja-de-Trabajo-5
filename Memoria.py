...
def proceso(env, name, time, ram, memory, instructions, speed):
    ...
    yield env.timeout(time) #El proceso debe esperar al event
    arrival = env.now
    ...
    while completed < instructions:
        ...
        with cpu.request() as r:
            ...
            yield env.timeout(running/speed) #máximo 1
            completed = completed + running #Ya ejecutó las instrucciones el CPU.
